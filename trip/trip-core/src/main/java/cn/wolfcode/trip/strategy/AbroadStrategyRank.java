...
@Component("abroadStrategyRank")
public class AbroadStrategyRank implements IStrategyRank {
    @Autowired
    ...
    public void sysnStrategyRankData() {
            ...
            queryWrapper.select("id", "sub_title", "title", "dest_id", "dest_name", "favornum", "thumbsupnum")
                    .eq("isabroad", 1).orderByDesc("favornum+thumbsupnum")
                    .last("LIMIT 10");
